package com.light.upgrade.view;
...
import com.light.upgrade.utils.MD5Utils;

import java.io.File;

import static com.light.upgrade.model.UpgradeInfoModel.ForceLevel.ABSOLUTE_FORCE;
import static com.light.upgrade.model.UpgradeInfoModel.ForceLevel.NOT_FORCE;
 ...
 */
public class LightDialogActivity extends BaseActivity {
    ...
    private void execute() {
        String title = upgradeInfoModel.getUpgradeTitle().length() > 0 ? upgradeInfoModel.getUpgradeTitle() : getString(R.string.dialog_title_default);
        String body = upgradeInfoModel.getUpgradeNotes();
//        if(upgradeInfoModel.getFileSize() > 0){
//            body += "\r\n 大小 "+ (upgradeInfoModel.getFileSize() / 1024) + "M";
//        }
